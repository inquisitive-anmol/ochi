...
const Footer = () => {
  return (
    <div className="w-full flex h-screen bg-zinc-900 landingPage-h1">
      <div className="w-1/2 px-10 py-10  h-full flex justify-between flex-col">
      ...
      <div className="w-1/2 py-10 ">
        ...
        <div className="dets mt-10 nav-a">
